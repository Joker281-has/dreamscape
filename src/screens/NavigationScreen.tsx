  ...
  return (
    <SafeAreaView style={styles.container} edges={["top"]}>
      <View style={styles.topArea}>
        <Animated.View style={[styles.arrowPlaceholder, { transform: [{ scale: arrowScale }] }] }>
      ...
      <View style={styles.bottomArea}>
        <TouchableOpacity style={styles.endButton} onPress={handleEnd} accessible={true} accessibilityRole="button" accessibilityLabel="End navigation" accessibilityHint="Stops navigation and returns to home" hitSlop={{ top: 10, bottom: 10, left: 10, right: 10 }}>
